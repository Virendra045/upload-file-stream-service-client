...
public class SpringKafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, Student> tenant1Factory() {
    ...
    @Bean
    public KafkaTemplate<String, Student> tenant1Template() {
        return new KafkaTemplate<>(tenant1Factory());
    }

    @Bean
    public ProducerFactory<String, Student> tenant2Factory() {
        Map<String, Object> configMap = new HashMap<>();
        configMap.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, ApplicationConstant.KAFKA_LOCAL_SERVER_CONFIG);
        configMap.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        configMap.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);
    ...
    @Bean
    public KafkaTemplate<String, Student> tenant2Template() {
        return new KafkaTemplate<>(tenant2Factory());
    }
    ...
    public ConsumerFactory<String, Student> consumerFactory() {
        ...
        configMap.put(JsonDeserializer.TRUSTED_PACKAGES, "com.spring.largefileupload.model");
//line-50
